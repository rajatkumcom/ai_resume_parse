...
class __TwigTemplate_f4d3eb5272e9e074c76a579a4f0a40fc extends Template
{
    private $source;
    private $macros = [];
...
($context["is_top_level_menu"] ?? null) && twig_get_attribute($this->env, $this->source, $context["item"], "below", [], "any", false, false, true, 129))) ? ("primary-nav-submenu-toggle-button") : (false))]), "html", null, true);
  ...
  ";
    ...
    {
        return new Source("", "core/themes/olivero/templates/navigation/menu--primary-menu.html.twig", "/Applications/MAMP/htdocs/demo/web/core/themes/olivero/templates/navigation/menu--primary-menu.html.twig");
    }
